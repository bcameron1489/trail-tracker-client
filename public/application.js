...
var config = {
  apiOrigins: {
    production: 'https://trail-tracker-api.herokuapp.com/'
...
var trackerIndex = function trackerIndex() {
  return $.ajax({
...
var updateTrail = function updateTrail(data) {
  return $.ajax({
...
var deleteTracker = function deleteTracker(data) {
  return $.ajax({
...
var trackersIndex = __webpack_require__(40);
var showUserTrails = __webpack_require__(41);
var store = __webpack_require__(3);

var onGetTrackersSuccess = function onGetTrackersSuccess(data) {
  var showTrackers = trackersIndex({ trackers: data.trackers });
  $('.user-content').empty();
...
var onGetTrackersFailure = function onGetTrackersFailure() {
  $('.trackers-response').html('Failed to retreive your trails');
};

var updateTrailSuccess = function updateTrailSuccess(data) {
...
var updateTrailFailure = function updateTrailFailure(data) {
...
var deleteTrackerSuccess = function deleteTrackerSuccess(data) {
...
var deleteTrackerFailure = function deleteTrackerFailure(data) {
...
var userTrailsSuccess = function userTrailsSuccess(data) {
  if (data.trackers.length > 0) {
    var showTrails = showUserTrails({ trackers: data.trackers });
...
var userTrailsFailure = function userTrailsFailure(data) {
...
module.exports = {
  onGetTrackersSuccess: onGetTrackersSuccess,
  onGetTrackersFailure: onGetTrackersFailure,
  updateTrailSuccess: updateTrailSuccess,
  updateTrailFailure: updateTrailFailure,
  deleteTrackerSuccess: deleteTrackerSuccess,
  deleteTrackerFailure: deleteTrackerFailure,
  userTrailsSuccess: userTrailsSuccess,
  userTrailsFailure: userTrailsFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var trackApi = __webpack_require__(7);
var ui = __webpack_require__(12);
var trackUi = __webpack_require__(8);

var onGetTrails = function onGetTrails(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.getTrails(data).then(ui.onGetTrailsSuccess).catch(ui.onGetTrailsFailure);
};

var onPostTrail = function onPostTrail(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.postTrail(data).then(ui.postTrailSuccess).then(trackApi.trackerIndex).then(trackUi.onGetTrackersSuccess).catch(ui.postTrailFailure);
};

var addTrailHandlers = function addTrailHandlers() {
  $('#get-trails').on('submit', onGetTrails);
  $('.content').on('submit', '.create-tracker', onPostTrail);
};

module.exports = {
  onGetTrails: onGetTrails,
  onPostTrail: onPostTrail,
  addTrailHandlers: addTrailHandlers
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var getTrails = function getTrails() {
  return $.ajax({
...
var postTrail = function postTrail(data) {
  return $.ajax({
    url: config.apiOrigin + '/trackers',
    method: 'POST',
    headers: {
...
var trailsIndex = __webpack_require__(23);
var store = __webpack_require__(3);

var onGetTrailsSuccess = function onGetTrailsSuccess(data) {
  $('.trails-response').html('Successfully retreived trails!');
  var showTrails = trailsIndex({ trails: data.trails });
  $('.content').html('');
  $('.content').append(showTrails);
  store.data = data.trails;
};

var onGetTrailsFailure = function onGetTrailsFailure(data) {
  $('.trails-response').html('Failed to retreive trails');
};

var postTrailSuccess = function postTrailSuccess(data) {
  $('.trails-response').html('Trail has been added!');
  store.tracker = data.tracker;
  store.data = data.user;
};

var postTrailFailure = function postTrailFailure(data) {
  $('.trails-response').html('Failed to add trail');
};

module.exports = {
  onGetTrailsSuccess: onGetTrailsSuccess,
  onGetTrailsFailure: onGetTrailsFailure,
  postTrailSuccess: postTrailSuccess,
  postTrailFailure: postTrailFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var onTrackerIndex = function onTrackerIndex(event) {
  event.preventDefault();
  api.trackerIndex().then(ui.onGetTrackersSuccess).catch(ui.onGetTrackersFailure);
};

var onUpdateTrail = function onUpdateTrail(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.updateTrail(data).then(ui.updateTrailSuccess).then(api.trackerIndex).then(ui.onGetTrackersSuccess).catch(ui.onGetTrackersFailure);
};

var onDeleteTracker = function onDeleteTracker(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.deleteTracker(data).then(ui.deleteTrackerSuccess).then(api.trackerIndex).then(ui.onGetTrackersSuccess).catch(ui.deletePlayerFailure);
};

var userTrailsView = function userTrailsView(event) {
  event.preventDefault();
  api.trackerIndex().then(clearContent()).then(ui.userTrailsSuccess).catch(ui.userTrailsFailure);
};

var addTrackerHandlers = function addTrackerHandlers() {
...
module.exports = {
  onTrackerIndex: onTrackerIndex,
  onUpdateTrail: onUpdateTrail,
  onDeleteTracker: onDeleteTracker,
  addTrackerHandlers: addTrackerHandlers
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var trailEvents = __webpack_require__(10);
...
var eventsTrails = __webpack_require__(10);
var eventsTrackers = __webpack_require__(14);
var apiTrails = __webpack_require__(11);
var uiTrails = __webpack_require__(12);
var apiTrackers = __webpack_require__(7);
var uiTrackers = __webpack_require__(8);
var breck = __webpack_require__(42);
var park = __webpack_require__(43);
var big = __webpack_require__(44);
var vail = __webpack_require__(45);
...
var onSignIn = function onSignIn(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.signIn(data).then(ui.onSignInSuccess).then(apiTrails.getTrails).then(uiTrails.onGetTrailsSuccess).catch(ui.onSignInFailure).then(apiTrackers.trackerIndex).then(uiTrackers.onGetTrackersSuccess);
};
...
var hidePostAuthForms = function hidePostAuthForms() {
...
var onShowImage = function onShowImage(event) {
...
var preAuthContent = function preAuthContent() {
  $('.auth-wrapper').hide();
};

var showPreAuthContent = function showPreAuthContent() {
  $('.auth-wrapper').show();
};

var showPostAuth = function showPostAuth() {
...
var hidePostAuth = function hidePostAuth() {
  $('.post-auth-forms').hide();
  $('.content-btn').hide();
  $('.user-button').hide();
  $('.content').html('');
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<ul class=\"trail-forms\" data-id=\""
    ...
    + " </div>\n  <div>Mountain: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.mountain : stack1), depth0))
    + " </div>\n  <div>Difficulty: "
    ...
    + " </div>\n  <div class=\"post-trail\">\n     <form class=\"create-tracker\">\n       <fieldset>\n       <input class=\"btn btn-primary post-button\" type =\"submit\" name=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" value=\"Add Trail\"></input>\n       <input class=\"id-value\" name=\"tracker[trail_id]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"hidden\"></input>\n       </fieldset>\n     </form>\n   </div>\n  </ul>\n\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.trails : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <ul class=\"tracker-forms\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <div> Name: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.trail : stack1)) != null ? stack1.name : stack1), depth0))
    + " </div>\n    <div> Difficulty: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.trail : stack1)) != null ? stack1.difficulty : stack1), depth0))
    + " </div>\n    <div> Rating: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.trail : stack1)) != null ? stack1.rating : stack1), depth0))
    + " </div>\n    <div> Completed: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.completed : stack1), depth0))
    + " </div>\n      <div class=\"update-trail\">\n        <form class=\"patch-trail\">\n          <fieldset>\n            <input class=\"btn btn-primary completed-button\" type =\"submit\" name=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" value=\"completed\"></input>\n            <input class=\"id-value\" name='tracker[id]' value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type='hidden'>\n            <input class=\"id-value\" name=\"tracker[trail_id]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.trail_id : stack1), depth0))
    + "\" type=\"hidden\"></input>\n            <input type=\"text\" name='tracker[completed]' class=\"clear-update-input\" placeholder='completed?'>\n          </fieldset>\n        </form>\n      </div>\n   </br>\n     <div class=\"delete-tracker-wrapper\">\n      <form class=\"delete-tracker\">\n        <input class=\"btn btn-primary delete-button\" type =\"submit\" name=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.trackers : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<div class=\"container user-trails-hbs\">\n  <div class=\"row\">\n    <div class=\"col-xl-12 user-content\">\n      <ul class=\"tracker-forms\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n        <div> Name: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.trail : stack1)) != null ? stack1.name : stack1), depth0))
    + "</div>\n        <div class=\"mountain\"> Mountain: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.trail : stack1)) != null ? stack1.mountain : stack1), depth0))
    + "</div>\n        <div> Difficulty: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.trail : stack1)) != null ? stack1.difficulty : stack1), depth0))
    + "</div>\n        <button class=\"btn btn-primary show-button\" type=\"button\"  data-mountain=\""
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.trail : stack1)) != null ? stack1.mountain : stack1), depth0))
    + "\">See Trail</button>\n      </ul>\n    </div>\n  </div>\n</div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<img class=\"breck-img\" src=\"https://i.imgur.com/HDkztjI.jpg?1\" alt=\"\">\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<img class=\"park-img\" src=\"https://i.imgur.com/5JUtgbm.jpg\">\n\n\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<img class=\"big-sky-img\" src=\"https://i.imgur.com/BqPpezE.jpg\" alt=\"\">\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<img class=\"vail-img\" src=\"https://i.imgur.com/RbBju0s.jpg?1\" alt=\"\">\n";
},"useData":true});
